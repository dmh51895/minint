                ...
                IN PRTL_USER_PROCESS_INFORMATION ProcessInformation)
{
    ...
    {
        /* This is a pretty bad failure. ((void)0) on checked builds and exit */
    ...
    if (ProcessInfo->ImageInformation.ImageSubSystemType == IMAGE_SUBSYSTEM_NATIVE)
    {
        /* Resume it */
             ...
             IN ULONG ParameterCount)
{
    ...
    return NtTerminateProcess(((HANDLE)(LONG_PTR)-1), Status);
}
      ...
      IN ULONG DebugFlag)
{
    ...
    /* Raise our priority */
    SetBasePriority = 11;
    Status = NtSetInformationProcess(((HANDLE)(LONG_PTR)-1),
                                     5,
