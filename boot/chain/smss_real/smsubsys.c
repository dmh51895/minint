...
SmpLocateKnownSubSysByCid(IN PCLIENT_ID ClientId)
{
    ...
    while (NextEntry != &SmpKnownSubSysHead)
    {
        ...
        Subsystem = ((SMP_SUBSYSTEM*)((char*)(NextEntry) - offsetof(SMP_SUBSYSTEM, Entry)));
                 ...
                 IN ULONG Flags)
{
    ...
    if (Flags & (SMP_POSIX_FLAG | SMP_OS2_FLAG))
    {
        ...
        ProcessInformation.ImageInformation.ImageSubSystemType = CreateProcess->Out.SubsystemType;
    }
    else
    {
    ...
    if (ProcessInformation.ImageInformation.ImageSubSystemType == IMAGE_SUBSYSTEM_NATIVE)
    {
    ...
    else
    {
        ...
        *(PULONGLONG)&CreateSession->DbgUiClientId = 0;
        ...
        Subsystem = SmpLocateKnownSubSysByType(MuSessionId,
                                               ProcessInformation.ImageInformation.ImageSubSystemType);
        if (!Subsystem)
        {
