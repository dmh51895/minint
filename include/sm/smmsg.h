...
/* MinNT additions not in ReactOS smmsg.h */
...
#define STATUS_NO_SUCH_PACKAGE   ((NTSTATUS)0xC000015AL)
...
#define SystemFlagsInformation   23
#define SystemSessionDetach      0x100
#define SystemSessionCreate      0x101
#define SystemExtendServiceTableInformation 0x102
#define FLG_DEBUG_INITIAL_COMMAND     0x00000002
#define FLG_DEBUG_INITIAL_COMMAND_EX  0x00000040
#define SharedUserData ((PVOID)0x7FFE0000)

#define STATUS_WAIT_1 ((NTSTATUS)0x00000101L)
typedef ULONGLONG *PULONGLONG;
#define RtlBsdItemBootGood 0
#define RtlBsdItemBootShutdown 1
#endif // _SM_MSG_
