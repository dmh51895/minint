...
| HAL | hal.dll | `hal/hal.c` — PIC, PIT 100Hz, COM1, VGA, port I/O | ✅ |
| Ke traps | KiTrap* family | `ke/trap.S` — 256 vectors, uniform KTRAP_FRAME | ✅ |
| Ke tables | KiSystemStartup GDT/IDT | `ke/idt.c` | ✅ |
| Ke IRQL | KfRaiseIrql/KfLowerIrql | `ke/irql.c` — bugchecks 0xA on violations | ✅ |
...
| Scheduler | KiDispatch (cooperative) | `ps/psmgr.c` round-robin | ✅ |
